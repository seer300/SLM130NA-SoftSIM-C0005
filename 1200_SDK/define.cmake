...
list(APPEND PRJ_DEF_LIST "FOTA_SUCC_REPORT=0")   #仅对OPENCPU产品有效，指示FOTA升级成功后是否立即启动CP核上报FOTA成功结果给云平台
...
if(${XY_SOC_VER} EQUAL 0)   #1200对标B0模组
	list(APPEND PRJ_DEF_LIST "MODULE_VER=2")     #模组产品形态
	...
	list(APPEND PRJ_DEF_LIST "RC26MCLKDIV=1")    #当SYS_CLK_SRC选择PLL时，该参数无意义
...
list(APPEND PRJ_DEF_LIST "XY_FOTA=0")
list(APPEND PRJ_DEF_LIST "CONFIG_FEATURE_FOTA=0") #此功能宏为CDP云FOTA功能，若用户不用CDP云FOTA功能，可以将此行注释掉或删除
...
list(APPEND PRJ_DEF_LIST "LPM_LOG_DEBUG=0") 
...
list(APPEND PRJ_DEF_LIST "MQTT=0")
